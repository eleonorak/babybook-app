    ...
    <x-slot name="header">
        ...
        <div class="sm:col-span-4 float-right">
            <a href="{{route('child.medical-treatments.create',['child'=>$child->id])}}"
               class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"> + Додади медицински третман</a>
        </div>
    </x-slot>
        ...
        <div class="border-l-2 mt-10">
            ...
            @if(!$medicalTreatments->isEmpty())
                ...
                @foreach ($medicalTreatments as $medicalTreatment)
                    <div style="background-color:{{$medicalTreatment->type ? $medicalTreatment->type->color : '#ccc'}}"
                        ...
                        <div class="flex-auto">
                            ...
                            <h1 class="text-lg">Време : {{$medicalTreatment->date}}</h1>
            ...
            <section class="mt-4 text-center">{{ $medicalTreatments->links() }}
            </section>
