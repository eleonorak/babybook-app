...
@php
    if('small' === $size) {
        ...
        $sizeClass = 'text-lg px-8 py-4 me-2';
    } else {
...
<button {{ $attributes->merge(['type' => 'submit', 'class' => 'text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 font-medium rounded-lg text-center  '.$sizeClass]) }}>
    {{ $slot }}
</button>
